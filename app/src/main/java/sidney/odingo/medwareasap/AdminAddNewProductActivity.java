...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void ValidateProductData() {
        ...
        if (ImageUri == null) {
            ...
            Toast.makeText(AdminAddNewProductActivity.this, "Image DESCRIPTION missing...", Toast.LENGTH_SHORT).show();

        } else if (TextUtils.isEmpty(Price)) {
            Toast.makeText(AdminAddNewProductActivity.this, "Image PRICE missing...", Toast.LENGTH_SHORT).show();

        } else if (TextUtils.isEmpty(Pname)) {
            Toast.makeText(AdminAddNewProductActivity.this, "Image NAME missing...", Toast.LENGTH_SHORT).show();
