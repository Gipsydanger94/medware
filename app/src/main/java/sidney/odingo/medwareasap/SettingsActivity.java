...
public class SettingsActivity extends AppCompatActivity {
    ...
    private TextView profileChangeTextBtn, closeTextBt, saveButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileChangeTextBtn = findViewById(R.id.setting_profile_change_image_btn);
        closeTextBt = findViewById(R.id.close_settings);
        saveButton = findViewById(R.id.update_settings);

        userInfoDisplay(ProfileImageView, fullNameEditText, userPhoneEditText, addressEditText);

        closeTextBt.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void uploadImage() {
        ...
        if (imageUri !=null) {
            ...
            final StorageReference fileRef = storageProfilePrictureRef.child(Prevalent.currentOnlineUsers.getPhone() + "jpg");
